...
public class Message implements Comparable<Message> {
        ...
        public void setEvacuationRouteList(Map<Integer,List<Coord>> evacuationRouteList) {
                this.evacuationRouteList = new HashMap<Integer,List<Coord>> (evacuationRouteList);
        }

        public Map<RouteEntry,List<Coord>> getRouteList () {
                return this.routeList;
        }

        public void setRouteList(Map<RouteEntry,List<Coord>> routeList) {
                this.routeList = routeList;
        }

        public List<Coord> getlocationList() {
                return this.locationList;
        }

        public void setlocationList(List<Coord> locationList) {
