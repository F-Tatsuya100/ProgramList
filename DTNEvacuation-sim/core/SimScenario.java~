...
public class SimScenario implements Serializable {
        ...
        public static final String GROUP_SAFETYFLAG_S = "safetyFlag";
        ...
        protected void createHosts() {
                ...
                for (int i=1; i<=nrofGroups; i++) {
                        ...
                        boolean safetyFlag = s.getBoolean(GROUP_SAFETYFLAG_S);
                        ...
                        for (int j=0; j<nrofHosts; j++) {
                                ...
                                host.setGroupId(gid);
                                host.setSafetyFlag(safetyFlag);
                                host.setRouteEntry();
                                hosts.add(host);

                                if (gid.equals("D")) {
                                    this.droneHost = host;
                                } else if (gid.equals("AP")) {
                                    host.setDroneHost(this.droneHost);
                                }
                        }
                }
        }
