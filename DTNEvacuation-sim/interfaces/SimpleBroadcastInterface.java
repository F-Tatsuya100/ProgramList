...
public class SimpleBroadcastInterface extends NetworkInterface {
	...
	public void connect(NetworkInterface anotherInterface) {
		if (isScanning()  
            ...
            if (!(this.host.gid.equals("AP") && anotherInterface.getHost().AParrival) &&
                !(anotherInterface.getHost().gid.equals("AP") && this.host.AParrival) &&
                !(this.host.gid.equals("P") && anotherInterface.getHost().gid.equals("D")) &&
                !(this.host.gid.equals("D") && anotherInterface.getHost().gid.equals("P")) &&
		!(this.host.gid.equals("CM") && anotherInterface.getHost().gid.equals("CM"))
                ) {
	...
	public void update() {
        ...
        if(this.getHost().gid.equals("AP")) {
            //System.out.println("SimpleBroadcast84 : " + this.getHost() + "   " + connections);
        }
